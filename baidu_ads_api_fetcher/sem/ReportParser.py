...
class ReportParser(object):
    ...
    def __init_mapping(self):
        ...
        self.mapping['adgroupId']='推广单元ID'
        self.mapping['adgroupName']='推广单元'
        ...
        self.mapping['impression']='展现量'
        self.mapping['click']='点击量'
        self.mapping['cost']='消费'
        self.mapping['cpc']='平均点击价格'
        self.mapping['ctr']='点击率'
        self.mapping['cpm']='千次展现消费'
