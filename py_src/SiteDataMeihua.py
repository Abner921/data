...
http://passport.meihua.info/SetPass.aspx?
b:http://adm.meihua.info/actionpage/GetInfo.aspx
bf:http://adm.meihua.info/
uid:peggy_peng
md5:Wsuekr/Bm1vvNRU6Hy39hw==
psd:123456
"""
...
MeihuaLoginAction = {
  ...
  'result': [{ 'output_key': 'MEIHUA_GETINFO_USER_MD5_URL',
               'response_regex' : 'GetInfo.aspx(.*)'
            }],
  'error_handling' : [{
    'error_regex' : ".*",
...
http://adm.meihua.info/actionpage/GetInfo.aspx?
uid:peggy_peng
MD5:Wsuekr/Bm1vvNRU6Hy39hw==
bf:http://adm.meihua.info/


在list里面搜索时获得的自动提示list：
http://adm.meihua.info/AjaxPage/QuerySearch.aspx?t=1&k=%20%E4%B8%87%E7%A7%91&pi=1
t:1
k: 万科
pi:1
response: {"ResultCount":"60","PageIndex":"1","PageNum":"3","ResultItemList":[{"ID":"9275|130000","Name":"徐州万科城(房地产)","NameEn":"XUZHOU VANKE CHENG"},{"
"""
...
MeihuaGetSearchCookieAction = {
  ...
  'headers': {
               ...
               'Referer': 'http://adm.meihua.info/ListView.aspx?adType=0',
               'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11'},
  'result': [ { 'output_key': 'MEIHUA_LAST_SEARCH_COOKIE',
                'result_regex': 'Set-Cookie:LastSearch_(.*);'}],
  'error_handling' : [{
    'error_regex' : ".*",
...
MEIHUA_ACTIONS = (
    MeihuaLoginAction, MeihuaGetSearchCookieAction, MeihuaListAllAction)
